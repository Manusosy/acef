                ...
                <div class="flex-1 flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl font-bold text-white mb-2 flex items-center gap-2">
                            <?php echo e(__('cookie_consent.title')); ?>
                        ...
                        <p class="text-sm text-gray-300 leading-relaxed max-w-3xl">
                            <?php echo e(__('cookie_consent.message')); ?>
                        ...
                        <a href="<?php echo e(route('cookies')); ?>" 
                           ...
                           target="_blank">
                            ...
                            <?php echo e(__('cookie_consent.learn_more')); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto lg:flex-shrink-0">
                    <button @click="rejectCookies()" 
                        ...
                        <span class="relative z-10 flex items-center justify-center gap-2">
                            ...
                            <?php echo e(__('cookie_consent.reject')); ?>
                    ...
                    <button @click="acceptCookies()" 
                        ...
                        <span class="relative z-10 flex items-center justify-center gap-2">
                            ...
                            <?php echo e(__('cookie_consent.accept')); ?>
...
<?php /**PATH C:\Users\ADMIN\Desktop\aceflaravel\acef\resources\views/components/cookie-consent.blade.php ENDPATH**/ ?>