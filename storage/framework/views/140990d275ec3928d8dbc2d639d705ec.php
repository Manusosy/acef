...
<?php $component->withAttributes([]); ?>
    <div class="mb-8 flex flex-col md:flex-row justify-between md:items-center gap-4">
        ...
        <a href="<?php echo e(route('admin.timeline-years.create')); ?>" class="inline-flex items-center justify-center bg-acef-green hover:bg-green-700 text-white font-bold px-6 py-3 rounded-xl transition-all transform hover:scale-105 shadow-lg shadow-green-500/20">
        ...
        <div class="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100 dark:border-gray-700 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="flex justify-between items-start mb-4">
                    <h2 class="text-4xl font-black text-acef-dark dark:text-white tracking-tight"><?php echo e($year->year); ?></h2>
                    <span class="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider <?php echo e($year->is_visible ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400'); ?>">
                        <?php echo e($year->is_visible ? 'Published' : 'Draft'); ?>
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <form action="<?php echo e(route('admin.timeline-years.destroy', $year)); ?>" method="POST" class="col-span-2 mt-2" onsubmit="return confirm('Are you sure? This will delete all achievements for this year.');">
                        <?php echo csrf_field(); ?>
    ...
    <div class="text-center py-20 bg-gray-50 dark:bg-gray-800 rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-700">
        ...
        <a href="<?php echo e(route('admin.timeline-years.create')); ?>" class="inline-flex items-center px-6 py-3 bg-acef-green text-white font-bold rounded-xl hover:bg-green-700 transition-colors">
            Create First Year
        </a>
    </div>
    <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ADMIN\Desktop\aceflaravel\acef\resources\views/admin/timeline-years/index.blade.php ENDPATH**/ ?>