...
<div x-data="layoutData" x-cloak>
        ...
        <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
            <div class="flex justify-between items-center h-16">
                    ...
                    <a href="/" class="flex flex-col lg:flex-row lg:items-center group">
                        <div class="flex items-center space-x-3">
                            <?php if($siteLogo): ?>
                                ...
                                <?php if($siteLogoDark): ?>
                                    <img src="<?php echo e(Storage::url($siteLogoDark)); ?>" alt="<?php echo e($siteName); ?>" 
                                ...
                                <?php endif; ?>
                            <?php else: ?>
                                <span class="text-acef-green font-black text-3xl tracking-tighter"><?php echo e($siteName); ?></span>
                            <?php endif; ?>
                        </div>
                        ...
                        <?php if($siteTagline): ?>
                            <div class="hidden xl:block border-l pl-4 ml-4 transition-colors duration-500"
                                ...
                                <p class="text-[9px] leading-tight font-bold uppercase tracking-[0.2em] max-w-[150px] transition-colors duration-500"
                                   :class="scrolled && !darkMode ? 'text-acef-dark/50' : 'text-white/50'"><?php echo e($siteTagline); ?></p>
                            </div>
                        <?php endif; ?>
                    </a>
                </div>
                ...
                <nav class="hidden lg:flex items-center gap-1 xl:gap-2 transition-colors duration-500"
                    ...
                    <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        ...
                        <div x-show="open" x-cloak
                            ...
                            <div class="relative bg-white dark:bg-[#0A260A] border border-gray-100 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden backdrop-blur-xl">
                                <div class="py-2">
                                    <a href="<?php echo e(route('about')); ?>" class="block px-6 py-3 text-[17px] font-bold text-[#0A260A] dark:text-white hover:bg-acef-light-green hover:text-[#0A260A] transition-colors">
                                        <?php echo e(__('navigation.who_we_are')); ?>

                                    </a>
                                    <a href="<?php echo e(route('team')); ?>" class="block px-6 py-3 text-[17px] font-bold text-[#0A260A] dark:text-white hover:bg-acef-light-green hover:text-[#0A260A] transition-colors">
                                        <?php echo e(__('navigation.our_team')); ?>

                                    </a>
                                    <a href="<?php echo e(route('partners')); ?>" class="block px-6 py-3 text-[17px] font-bold text-[#0A260A] dark:text-white hover:bg-acef-light-green hover:text-[#0A260A] transition-colors">
                                        <?php echo e(__('navigation.our_partners')); ?>

                                    </a>
                                    <a href="<?php echo e(route('accreditations')); ?>" class="block px-6 py-3 text-[17px] font-bold text-[#0A260A] dark:text-white hover:bg-acef-light-green hover:text-[#0A260A] transition-colors">
                                        <?php echo e(__('navigation.accreditations')); ?>
                    ...
                    <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        <button class="relative px-3 py-2 text-xs xl:text-sm font-serif font-black uppercase tracking-[0.15em] hover:text-acef-light-green transition-all flex items-center gap-1">
                            <?php echo e(__('navigation.our_work')); ?>
                                ...
                                <div class="grid grid-cols-3 divide-x divide-gray-100 dark:divide-white/5">
                                    ...
                                    <div class="p-6 h-full flex flex-col">
                                        ...
                                        <div class="space-y-3 flex-1 text-left">
                                            <a href="<?php echo e(route('programmes')); ?>" class="block text-[17px] font-bold text-[#0A260A] dark:text-white hover:text-acef-green dark:hover:text-acef-light-green transition-colors">
                                                <?php echo e(__('navigation.programmes')); ?>
                                    ...
                                    <div class="p-6 h-full flex flex-col">
                                        ...
                                        <div class="space-y-3 flex-1 text-left">
                                            <a href="<?php echo e(route('projects')); ?>" class="block text-[17px] font-bold text-[#0A260A] dark:text-white hover:text-acef-green dark:hover:text-acef-light-green transition-colors">
                                    ...
                                    <div class="p-6 h-full flex flex-col">
                                        ...
                                        <div class="space-y-3 flex-1 text-left">
                                            <a href="<?php echo e(route('impact')); ?>" class="block text-[17px] font-bold text-[#0A260A] dark:text-white hover:text-acef-green dark:hover:text-acef-light-green transition-colors">
                                                <?php echo e(__('navigation.impact')); ?>
                    ...
                    <a href="<?php echo e(route('get-involved')); ?>"
                        class="relative group px-3 py-2 text-xs xl:text-sm font-serif font-black uppercase tracking-[0.15em] hover:text-acef-light-green transition-all">
                        <?php echo e(__('navigation.get_involved')); ?>
                    ...
                    <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        <button class="relative px-3 py-2 text-xs xl:text-sm font-serif font-black uppercase tracking-[0.15em] hover:text-acef-light-green transition-all flex items-center gap-1">
                            <?php echo e(__('navigation.resources')); ?>
                        ...
                        <div x-show="open" x-cloak
                            ...
                            <div class="relative bg-white dark:bg-[#0A260A] border border-gray-100 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden backdrop-blur-xl">
                                <div class="py-2">
                                    <a href="<?php echo e(route('resources')); ?>" class="block px-6 py-3 text-[17px] font-bold text-[#0A260A] dark:text-white hover:bg-acef-light-green hover:text-[#0A260A] transition-colors">
                                        <?php echo e(__('navigation.knowledge_hub')); ?>

                                    </a>
                                    <a href="<?php echo e(route('news')); ?>" class="block px-6 py-3 text-[17px] font-bold text-[#0A260A] dark:text-white hover:bg-acef-light-green hover:text-[#0A260A] transition-colors">
                                        <?php echo e(__('navigation.news_insights')); ?>

                                    </a>
                                    <a href="<?php echo e(route('gallery')); ?>" class="block px-6 py-3 text-[17px] font-bold text-[#0A260A] dark:text-white hover:bg-acef-light-green hover:text-[#0A260A] transition-colors">
                                        <?php echo e(__('navigation.media_gallery')); ?>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="hidden lg:flex items-center gap-1 xl:gap-2">
                        ...
                        <button @click="toggleDarkMode()"
                            ...
                            :title="darkMode ? '<?php echo e(__('pages.layout.header.theme_switch_light')); ?>' : '<?php echo e(__('pages.layout.header.theme_switch_dark')); ?>'">
    ...
    <div x-show="mobileMenuOpen" x-cloak
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="p-6 space-y-8">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3">
                        <?php if($siteLogo): ?>
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <span class="text-acef-green font-black text-2xl tracking-tighter"><?php echo e($siteName); ?></span>
                        <?php endif; ?>
                    </div>
                ...
                <!-- Nav -->
                <nav class="space-y-1">
                    <a href="<?php echo e(route('home')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-3 text-white font-bold hover:bg-white/5 rounded-xl transition-colors"><?php echo e(__('navigation.home')); ?></a>
                    ...
                    <div x-data="{ expanded: false }" class="space-y-1">
                        <button @click="expanded = !expanded" class="w-full flex justify-between items-center px-4 py-3 text-white font-bold hover:bg-white/5 rounded-xl transition-colors">
                            <span><?php echo e(__('navigation.about')); ?></span>
                        ...
                        <div x-show="expanded" x-collapse class="pl-4 space-y-1">
                            <a href="<?php echo e(route('about')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.who_we_are')); ?></a>
                            <a href="<?php echo e(route('team')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.our_team')); ?></a>
                            <a href="<?php echo e(route('partners')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.our_partners')); ?></a>
                            <a href="<?php echo e(route('accreditations')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.accreditations')); ?></a>
                        </div>
                    </div>

                    <div x-data="{ expanded: false }" class="space-y-1">
                        <button @click="expanded = !expanded" class="w-full flex justify-between items-center px-4 py-3 text-white font-bold hover:bg-white/5 rounded-xl transition-colors">
                            <span><?php echo e(__('navigation.our_work')); ?></span>
                            <svg class="w-4 h-4 transition-transform" :class="expanded ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                        <div x-show="expanded" x-collapse class="pl-4 space-y-1">
                            <a href="<?php echo e(route('programmes')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.programmes')); ?></a>
                            <a href="<?php echo e(route('projects')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.projects')); ?></a>
                            <a href="<?php echo e(route('impact')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.impact')); ?></a>
                        </div>
                    </div>
                    
                    <div x-data="{ expanded: false }" class="space-y-1">
                        <button @click="expanded = !expanded" class="w-full flex justify-between items-center px-4 py-3 text-white font-bold hover:bg-white/5 rounded-xl transition-colors">
                            <span><?php echo e(__('navigation.resources')); ?></span>
                            <svg class="w-4 h-4 transition-transform" :class="expanded ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                        <div x-show="expanded" x-collapse class="pl-4 space-y-1">
                            <a href="<?php echo e(route('resources')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.knowledge_hub')); ?></a>
                            <a href="<?php echo e(route('news')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.news_insights')); ?></a>
                            <a href="<?php echo e(route('gallery')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-2 text-white/60 hover:text-acef-light-green text-sm font-medium"><?php echo e(__('navigation.media_gallery')); ?></a>
                        </div>
                    </div>

                    <a href="<?php echo e(route('get-involved')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-3 text-white font-bold hover:bg-white/5 rounded-xl transition-colors"><?php echo e(__('navigation.get_involved')); ?></a>
                    <a href="<?php echo e(route('contact')); ?>" @click="mobileMenuOpen = false" class="block px-4 py-3 text-white font-bold hover:bg-white/5 rounded-xl transition-colors"><?php echo e(__('navigation.contact')); ?></a>
                </nav>
                ...
                <div class="space-y-3 pt-6 border-t border-white/10">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="px-4 pb-4 border-b border-white/10 mb-4">
                            ...
                            <div class="text-white font-bold mb-4"><?php echo e(Auth::user()->name); ?></div>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center py-2 text-white font-bold hover:text-acef-green transition-colors">
                    ...
                    <?php else: ?>
                        <div class="grid grid-cols-2 gap-3 px-4 pb-6 border-b border-white/10 mb-4">
                            <a href="<?php echo e(route('login')); ?>" class="flex justify-center items-center py-2.5 text-white font-bold hover:text-acef-green hover:bg-white/10 transition-colors bg-white/5 rounded-lg border border-white/10">
                                Login
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="flex justify-center items-center py-2.5 text-acef-dark font-bold hover:bg-white/90 transition-colors bg-white rounded-lg">
                                Register
                            </a>
                        </div>
                    <?php endif; ?>
                    ...
                    <a href="<?php echo e(route('donate')); ?>" class="block w-full py-4 bg-acef-gold text-[#0A260A] font-black text-center text-sm uppercase tracking-widest rounded-xl hover:bg-white hover:text-acef-green transition-colors shadow-lg">
                        <?php echo e(__('buttons.donate')); ?>
    ...
    <div x-show="searchOpen" x-cloak
        ...
        <div class="w-full max-w-4xl px-4" @click.away="searchOpen = false">
            <div class="relative">
                <form action="<?php echo e(route('search')); ?>" method="GET">
                    <input type="text" name="q" 
                           ...
                           placeholder="<?php echo e(__('pages.layout.header.search_placeholder')); ?>"
                           x-ref="searchInput"
            ...
            <p class="mt-4 text-center text-white/40 font-mono text-sm uppercase tracking-widest"><?php echo e(__('pages.common.press_esc_to_close')); ?></p>
        </div>
    </div>
</div>
...
</style><?php /**PATH C:\Users\ADMIN\Desktop\aceflaravel\acef\resources\views/components/header.blade.php ENDPATH**/ ?>