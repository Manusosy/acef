...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero','data' => ['page' => $homePage,'slides' => $heroSlides,'breadcrumb' => __('pages.home.founded'),'title' => ''.__('pages.home.hero_title').'','subtitle' => ''.__('pages.home.hero_subtitle').'','height' => '','minHeight' => '','class' => 'h-screen md:h-[70vh] min-h-[600px]','style' => 'display: flex; align-items: center; height: 85vh; min-height: 600px;','imageUrl' => '/hero_marine_ecosystem_1766827540454.png']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
