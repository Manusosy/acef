...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero','data' => ['page' => $homePage,'slides' => $heroSlides,'breadcrumb' => __('pages.home.founded'),'title' => ''.__('pages.home.hero_title').'','subtitle' => ''.__('pages.home.hero_subtitle').'','height' => 'h-[85vh] md:h-[70vh]','minHeight' => 'min-h-[600px] md:min-h-[600px]','imageUrl' => '/hero_marine_ecosystem_1766827540454.png']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['page' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($homePage),'slides' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($heroSlides),'breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('pages.home.founded')),'title' => ''.__('pages.home.hero_title').'','subtitle' => ''.__('pages.home.hero_subtitle').'','height' => 'h-[85vh] md:h-[70vh]','min-height' => 'min-h-[600px] md:min-h-[600px]','image-url' => '/hero_marine_ecosystem_1766827540454.png']); ?>
