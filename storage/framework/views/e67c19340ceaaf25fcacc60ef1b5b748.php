    ...
    <div class="max-w-2xl w-full text-center">
        ...
        <div class="mb-8">
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
                <?php echo e(__('errors.500.title')); ?>

            </h2>
            <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                <?php echo e(__('errors.500.message')); ?>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('home')); ?>" 
               class="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-white bg-acef-green hover:bg-acef-dark rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg">
                ...
                <?php echo e(__('errors.500.go_home')); ?>
            ...
            <button onclick="location.reload()" 
                ...
                <?php echo e(__('errors.500.try_again')); ?>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
            <p class="text-sm text-gray-500 dark:text-gray-400">
                <?php echo e(__('errors.500.support_message')); ?>

                <a href="<?php echo e(route('contact')); ?>" class="text-acef-green hover:text-acef-dark font-medium underline">
                    <?php echo e(__('errors.500.contact_support')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\aceflaravel\acef\resources\views/errors/500.blade.php ENDPATH**/ ?>