...
return [
    'home' => [
        'hero_title' => 'Расширение прав <br><span class="text-acef-green">низовых инициатив</span> для <br>устойчивого будущего',
        'hero_subtitle' => 'Ведущие молодежные действия по решению тройного планетарного кризиса в Африке.',
        'founded' => 'Основано в 2020 · Зарегистрировано в 2021',
        'who_we_are_title' => 'Кто мы',
        'who_we_are_heading' => 'Африканский фонд климата и <br><span class="text-acef-green italic">окружающей среды</span>',
        'who_we_are_text' => 'ACEF — это неправительственная организация, ориентированная на молодежь, которая занимается расширением прав и возможностей молодежи и женщин на низовом уровне, поддерживая местные инициативы по решению <span class="text-acef-dark font-bold">тройного планетарного кризиса</span>: изменения климата, потери биоразнообразия и загрязнения.',
        'who_we_are_subtext' => 'Зарегистрированные в различных африканских странах, мы работаем над повышением экологической устойчивости и продвижением устойчивых средств к существованию через инновационные решения, возглавляемые сообществом.',
        'countries' => 'Страны',
        'members' => 'Участники',
        'programmes_title' => 'Наши Программы',
        'programmes_subtitle' => 'Комплексные инициативы, охватывающие все аспекты сохранения морской среды и окружающей среды.',
        'featured_projects_title' => 'Избранные проекты',
        'featured_projects_subtitle' => 'Недавние значимые инициативы в наших основных областях.',
        'global_impact_title' => 'Наше глобальное влияние',
        'global_impact_subtitle' => 'Распространяется по всей Африке для восстановления баланса наших самых жизненно важных экосистем.',
        'news_title' => 'Новости и идеи',
        'news_subtitle' => 'Будьте в курсе последних обновлений и историй с полей.',
        'partners_title' => 'Наши глобальные партнеры',
        'programmes' => [
            [
                'title' => 'Защита Атлантического побережья',
                'desc' => 'Восстановление и защита биоразнообразия западноафриканских берегов.',
                'icon' => 'blue',
            ],
            [
                'title' => 'Континентальные морские экосистемы',
                'desc' => 'Сохранение внутренних водоемов и устьев рек по всему континенту.',
                'icon' => 'green',
            ],
            [
                'title' => 'Морские исследования и наука',
                'desc' => 'Научные исследования для понимания нашего дна океана и видов.',
                'icon' => 'indigo',
            ],
            [
                'title' => 'Адаптация к изменению климата',
                'desc' => 'Помощь сообществам в адаптации к повышению уровня моря и изменению климата.',
                'icon' => 'amber',
            ],
            [
                'title' => 'Сохранение природного биоразнообразия',
                'desc' => 'Защита исчезающих видов птиц и водных организмов в их среде обитания.',
                'icon' => 'emerald',
            ],
            [
                'title' => 'Контроль загрязнения воды',
                'desc' => 'Решение проблемы пластиковых отходов и промышленных стоков в морской среде.',
                'icon' => 'sky',
            ],
            [
                'title' => 'Агролесомелиорация для биоразнообразия',
                'desc' => 'Восстановление лесного покрова для защиты водосборных бассейнов и биоразнообразия.',
                'icon' => 'lime',
            ],
            [
                'title' => 'Развитие экотуризма',
                'desc' => 'Устойчивые модели туризма, приносящие пользу как людям, так и природе.',
                'icon' => 'cyan',
            ],
            [
                'title' => 'Здоровье и окружающая среда',
                'desc' => 'Связь здоровья сообщества с чистой и безопасной окружающей средой.',
                'icon' => 'rose',
            ],
            [
                'title' => 'Расширение прав лидеров завтрашнего дня',
                'desc' => 'Обучение следующего поколения защитников окружающей среды.',
                'icon' => 'violet',
            ],
        ],
        'projects' => [
            [
                ...
                'title' => 'Чистая энергия для прибрежных школ',
                'desc' => 'Внедрение автономных солнечных решений для 50 школ вдоль побережья Кении.',
                'image' => '/project_solar_panels_1766827705821.png',
            ],
            [
                'category' => 'Лесовосстановление',
                'title' => 'Создание устойчивых горных лесов',
                'desc' => 'Защита водосборных бассейнов посредством инициатив по посадке деревьев под руководством сообщества.',
                'image' => '/project_tree_planting_1766827726209.png',
            ],
            [
                'category' => 'Морская консервация',
                'title' => 'Восстановление мангровых лесов',
                'desc' => 'Восстановление 1000 гектаров мангровых зарослей для защиты от береговой эрозии.',
