...
return [
    'home' => [
        'hero_title' => '<span class="text-acef-green">Basisbewegungen</span> für eine <br>nachhaltige Zukunft stärken',
        'hero_subtitle' => 'Führende jugendgeführte Maßnahmen zur Bewältigung der dreifachen planetaren Krise in Afrika.',
        'founded' => 'Gegründet 2020 · Registriert 2021',
        'who_we_are_title' => 'Wer wir sind',
        'who_we_are_heading' => 'Afrikanische Stiftung für Klima und <br><span class="text-acef-green italic">Umwelt</span>',
        'who_we_are_text' => 'ACEF ist eine jugendorientierte Nichtregierungsorganisation, die sich der Stärkung von Jugendlichen und Frauen an der Basis widmet und lokal gesteuerte Initiativen zur Bewältigung der <span class="text-acef-dark font-bold">dreifachen planetaren Krise</span> unterstützt: Klimawandel, Verlust der Artenvielfalt und Umweltverschmutzung.',
        'who_we_are_subtext' => 'Registriert in verschiedenen afrikanischen Nationen, arbeiten wir daran, die ökologische Widerstandsfähigkeit zu verbessern und nachhaltige Lebensgrundlagen durch innovative, gemeinschaftsgeführte Lösungen zu fördern.',
        'countries' => 'Länder',
        'members' => 'Mitglieder',
        'programmes_title' => 'Unsere Programme',
        'programmes_subtitle' => 'Umfassende Initiativen, die jeden Aspekt des Meeres- und Umweltschutzes abdecken.',
        'featured_projects_title' => 'Ausgewählte Projekte',
        'featured_projects_subtitle' => 'Aktuelle wirkungsvolle Initiativen in unseren Schwerpunktbereichen.',
        'global_impact_title' => 'Unsere globale Wirkung',
        'global_impact_subtitle' => 'Erstreckt sich über ganz Afrika, um das Gleichgewicht unserer wichtigsten Ökosysteme wiederherzustellen.',
        'news_title' => 'Neuigkeiten & Einblicke',
        'news_subtitle' => 'Bleiben Sie informiert mit den neuesten Updates und Geschichten aus dem Feld.',
        'partners_title' => 'Unsere globalen Partner',
        'programmes' => [
            [
                'title' => 'Schutz der Atlantikküste',
                'desc' => 'Wiederherstellung und Schutz der Artenvielfalt der westafrikanischen Küsten.',
                'icon' => 'blue',
            ],
            [
                'title' => 'Kontinentale Meeresökosysteme',
                'desc' => 'Erhaltung von Binnengewässern und Flussmündungen auf dem ganzen Kontinent.',
                'icon' => 'green',
            ],
            [
                'title' => 'Meeresforschung & Wissenschaft',
                'desc' => 'Wissenschaftliche Erforschung zum Verständnis unseres Meeresbodens und der Arten.',
                'icon' => 'indigo',
            ],
            [
                'title' => 'Anpassung an den Klimawandel',
                'desc' => 'Unterstützung von Gemeinschaften bei der Anpassung an den steigenden Meeresspiegel und das sich ändernde Klima.',
                'icon' => 'amber',
            ],
            [
                'title' => 'Erhaltung der Artenvielfalt',
                'desc' => 'Schutz gefährdeter Vogel- und Wasserarten in ihren Lebensräumen.',
                'icon' => 'emerald',
            ],
            [
                'title' => 'Kontrolle der Wasserverschmutzung',
                'desc' => 'Bekämpfung von Plastikmüll und Industrieabwässern in Meeresumgebungen.',
                'icon' => 'sky',
            ],
            [
                'title' => 'Agroforstwirtschaft für Biodiversität',
                'desc' => 'Wiederherstellung der Waldbedeckung zum Schutz von Wassereinzugsgebieten und Artenvielfalt.',
                'icon' => 'lime',
            ],
            [
                'title' => 'Ökotourismus-Entwicklung',
                'desc' => 'Nachhaltige Tourismusmodelle, die sowohl Menschen als auch der Natur zugutekommen.',
                'icon' => 'cyan',
            ],
            [
                'title' => 'Gesundheit & Umwelt',
                'desc' => 'Verbindung von Gemeindegesundheit mit einer sauberen und sicheren Umwelt.',
                'icon' => 'rose',
            ],
            [
                'title' => 'Stärkung der Führungskräfte von morgen',
                'desc' => 'Ausbildung der nächsten Generation von Umweltanwälten.',
                'icon' => 'violet',
            ],
        ],
        'projects' => [
            [
                ...
                'title' => 'Saubere Energie für Küstenschulen',
                'desc' => 'Implementierung von netzunabhängigen Solarlösungen für 50 Schulen entlang der kenianischen Küste.',
                'image' => '/project_solar_panels_1766827705821.png',
            ],
            [
                'category' => 'Aufforstung',
                'title' => 'Aufbau widerstandsfähiger Hangwälder',
                'desc' => 'Schutz von Wassereinzugsgebieten durch gemeinschaftsgeführte Baumpflanzinitiativen.',
                'image' => '/project_tree_planting_1766827726209.png',
            ],
            [
                'category' => 'Meeresschutz',
                'title' => 'Wiederherstellung von Mangrovenwäldern',
                'desc' => 'Wiederherstellung von 1.000 Hektar Mangroven zum Schutz vor Küstenerosion.',
