...
return [
    'home' => [
        'hero_title' => 'Зајакнување на <br><span class="text-acef-green">Локалните Заедници</span> за <br>Одржлива Иднина',
        'hero_subtitle' => 'Водечка акција предводена од младите за решавање на тројната планетарна криза низ Африка.',
        'founded' => 'Основана 2020 · Регистрирана 2021',
        'who_we_are_title' => 'Кои сме ние',
        'who_we_are_heading' => 'Африканска Фондација за Клима и <br><span class="text-acef-green italic">Животна Средина</span>',
        'who_we_are_text' => 'ACEF е невладина организација фокусирана на младите, посветена на зајакнување на младите и жените од локалните заедници, поддржувајќи иницијативи за решавање на <span class="text-acef-dark font-bold">тројната планетарна криза</span>: климатските промени, губењето на биолошката разновидност и загадувањето.',
        'who_we_are_subtext' => 'Регистрирани во различни африкански нации, работиме на подобрување на еколошката отпорност и промовирање на одржливи средства за живот преку иновативни решенија предводени од заедницата.',
        'countries' => 'Земји',
        'members' => 'Членови',
        'programmes_title' => 'Нашите Програми',
        'programmes_subtitle' => 'Сеопфатни иницијативи дизајнирани да го покријат секој аспект на зачувување на морето и животната средина.',
        'featured_projects_title' => 'Избрани Проекти',
        'featured_projects_subtitle' => 'Неодамнешни влијателни иницијативи во нашите фокусни области.',
        'global_impact_title' => 'Нашето Глобално Влијание',
        'global_impact_subtitle' => 'Проширување низ Африка за враќање на рамнотежата во нашите најважни екосистеми.',
        'news_title' => 'Вести и Согледувања',
        'news_subtitle' => 'Бидете информирани со најновите ажурирања и приказни од теренот.',
        'partners_title' => 'Нашите Глобални Партнери и Поддржувачи',
        'programmes' => [
            [
                'title' => 'Заштита на атлантскиот брег',
                'desc' => 'Обновување и заштита на биолошката разновидност на западноафриканските брегови.',
                'icon' => 'blue',
            ],
            [
                'title' => 'Континентални морски екосистеми',
                'desc' => 'Внатрешни водни тела и зачувување на речното устие низ целиот континент.',
                'icon' => 'green',
            ],
            [
                'title' => 'Морско истражување и наука',
                'desc' => 'Научно истражување за да се разбере нашето дно и видови на океанот.',
                'icon' => 'indigo',
            ],
            [
                'title' => 'Адаптација на климатските промени',
                'desc' => 'Помагање на заедниците да се прилагодат на зголемувањето на нивото на морето и менување на климата.',
                'icon' => 'amber',
            ],
            [
                'title' => 'Зачувување на биолошката разновидност',
                'desc' => 'Заштита на загрозените птичји и водни видови во нивните живеалишта.',
                'icon' => 'emerald',
            ],
            [
                'title' => 'Контрола на загадување на водите',
                'desc' => 'Решавање на пластичниот отпад и индустриското истекување во морските средини.',
                'icon' => 'sky',
            ],
            [
                'title' => 'Агро-шумарство за биолошка разновидност',
                'desc' => 'Обновување на шумската покривка за заштита на сливовите на вода и биолошката разновидност.',
                'icon' => 'lime',
            ],
            [
                'title' => 'Развој на екотуризмот',
                'desc' => 'Одржливи туризам модели кои имаат корист и за луѓето и за природата.',
                'icon' => 'cyan',
            ],
            [
                'title' => 'Здравје и животна средина',
                'desc' => 'Поврзување на здравјето на заедницата со чиста и безбедна околина.',
                'icon' => 'rose',
            ],
            [
                'title' => 'Овластување на лидерите на утрешниот ден',
                'desc' => 'Обука на следната генерација застапници за животна средина.',
                'icon' => 'violet',
            ],
        ],
        'projects' => [
            [
                'category' => 'Обновлива енергија',
                'title' => 'Чиста енергија за крајбрежните училишта',
                'desc' => 'Спроведување на решенија за сончева енергија надвор од мрежата за 50 училишта долж брегот на Кенија.',
                'image' => '/project_solar_panels_1766827705821.png',
            ],
            [
                'category' => 'Решумирање',
                'title' => 'Изградба на отпорни ридски шуми',
                'desc' => 'Заштита на сливовите на вода преку иницијативи за садење дрвја предводени од заедницата.',
                'image' => '/project_tree_planting_1766827726209.png',
            ],
            [
                'category' => 'Морска конзервација',
                'title' => 'Обнова на шумите од мангрови',
                'desc' => 'Враќање на 1.000 хектари мангрови за да се заштити од ерозија на крајбрежјето.',
