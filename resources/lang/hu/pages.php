...
return [
    'home' => [
        ...
        'programmes' => [
            [
                'title' => 'Atlantic Coast Protection',
                'desc' => 'Restoring and protecting the biodiversity of West African shores.',
                'icon' => 'blue',
            ],
            [
                'title' => 'Continental Marine Ecosystems',
                'desc' => 'Inland water bodies and river mouth conservation across the continent.',
                'icon' => 'green',
            ],
            [
                'title' => 'Marine Research & Science',
                'desc' => 'Scientific exploration to understand our ocean floor and species.',
                'icon' => 'indigo',
            ],
            [
                'title' => 'Climate Change Adaptation',
                'desc' => 'Helping communities adapt to rising sea levels and changing climates.',
                'icon' => 'amber',
            ],
            [
                'title' => 'Nature Biodiversity Conservation',
                'desc' => 'Protecting endangered avian and aquatic species in their habitats.',
                'icon' => 'emerald',
            ],
            [
                'title' => 'Water Pollution Control',
                'desc' => 'Addressing plastic waste and industrial runoff in marine environments.',
                'icon' => 'sky',
            ],
            [
                'title' => 'Agro-forestry for Biodiversity',
                'desc' => 'Restoring forest cover to protect water catchments and biodiversity.',
                'icon' => 'lime',
            ],
            [
                'title' => 'Eco-Tourism Development',
                'desc' => 'Sustainable tourism models that benefit both people and nature.',
                'icon' => 'cyan',
            ],
            [
                'title' => 'Health & Environment',
                'desc' => 'Linking community health with a clean and safe environment.',
                'icon' => 'rose',
            ],
            [
                'title' => 'Empowering Leaders of Tomorrow',
                'desc' => 'Training the next generation of environmental advocates.',
                'icon' => 'violet',
            ],
        ],
        'projects' => [
