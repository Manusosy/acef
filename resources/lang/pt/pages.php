...
return [
    'home' => [
        'hero_title' => 'Empoderando a <br><span class="text-acef-green">Base</span> para um <br>Futuro Sustentável',
        'hero_subtitle' => 'Liderando a ação juvenil para enfrentar a tripla crise planetária na África.',
        'founded' => 'Fundada em 2020 · Registrada em 2021',
        'who_we_are_title' => 'Quem somos',
        'who_we_are_heading' => 'Fundação Africana para o Clima e <br><span class="text-acef-green italic">Meio Ambiente</span>',
        'who_we_are_text' => 'ACEF é uma organização não governamental focada na juventude, dedicada a empoderar jovens e mulheres da base, apoiando iniciativas locais para enfrentar a <span class="text-acef-dark font-bold">tripla crise planetária</span>: mudança climática, perda de biodiversidade e poluição.',
        'who_we_are_subtext' => 'Registrada em várias nações africanas, trabalhamos para aumentar a resiliência ambiental e promover meios de subsistência sustentáveis através de soluções inovadoras lideradas pela comunidade.',
        'countries' => 'Países',
        'members' => 'Membros',
        'programmes_title' => 'Nossos Programas',
        'programmes_subtitle' => 'Iniciativas abrangentes projetadas para cobrir todos os aspectos da conservação marinha e ambiental.',
        'featured_projects_title' => 'Projetos em Destaque',
        'featured_projects_subtitle' => 'Iniciativas recentes e impactantes em nossas áreas de foco.',
        'global_impact_title' => 'Nosso impacto global',
        'global_impact_subtitle' => 'Espalhando-se por toda a África para restaurar o equilíbrio de nossos ecossistemas mais vitais.',
        'news_title' => 'Notícias e Insights',
        'news_subtitle' => 'Mantenha-se informado com as últimas atualizações e histórias do campo.',
        'partners_title' => 'Nossos Parceiros Globais',
        'programmes' => [
            [
                'title' => 'Proteção da Costa Atlântica',
                'desc' => 'Restaurando e protegendo a biodiversidade das costas da África Ocidental.',
                'icon' => 'blue',
            ],
            [
                'title' => 'Ecossistemas Marinhos Continentais',
                'desc' => 'Conservação de corpos d\'água interiores e fozes de rios em todo o continente.',
                'icon' => 'green',
            ],
            [
                'title' => 'Pesquisa e Ciência Marinha',
                'desc' => 'Exploração científica para entender nosso fundo do oceano e espécies.',
                'icon' => 'indigo',
            ],
            [
                'title' => 'Adaptação às Mudanças Climáticas',
                'desc' => 'Ajudando comunidades a se adaptarem ao aumento do nível do mar e mudanças climáticas.',
                'icon' => 'amber',
            ],
            [
                'title' => 'Conservação da Biodiversidade Natural',
                'desc' => 'Protegendo espécies aviárias e aquáticas ameaçadas em seus habitats.',
                'icon' => 'emerald',
            ],
            [
                'title' => 'Controle da Poluição da Água',
                'desc' => 'Abordando resíduos plásticos e escoamento industrial em ambientes marinhos.',
                'icon' => 'sky',
            ],
            [
                'title' => 'Agrofloresta para Biodiversidade',
                'desc' => 'Restaurando a cobertura florestal para proteger bacias hidrográficas e biodiversidade.',
                'icon' => 'lime',
            ],
            [
                'title' => 'Desenvolvimento do Ecoturismo',
                'desc' => 'Modelos de turismo sustentável que beneficiam tanto as pessoas quanto a natureza.',
                'icon' => 'cyan',
            ],
            [
                'title' => 'Saúde e Meio Ambiente',
                'desc' => 'Vinculando a saúde da comunidade a um ambiente limpo e seguro.',
                'icon' => 'rose',
            ],
            [
                'title' => 'Empoderando Líderes do Amanhã',
                'desc' => 'Treinando a próxima geração de defensores ambientais.',
                'icon' => 'violet',
            ],
        ],
        'projects' => [
            [
                ...
                'title' => 'Energia Limpa para Escolas Costeiras',
                'desc' => 'Implementando soluções solares fora da rede para 50 escolas ao longo da costa queniana.',
                'image' => '/project_solar_panels_1766827705821.png',
            ],
            [
                'category' => 'Reflorestamento',
                'title' => 'Construindo Florestas de Encosta Resilientes',
                'desc' => 'Protegendo bacias hidrográficas através de iniciativas de plantio de árvores lideradas pela comunidade.',
                'image' => '/project_tree_planting_1766827726209.png',
            ],
            [
                'category' => 'Conservação Marinha',
                'title' => 'Restauração de Manguezais',
                'desc' => 'Restaurando 1.000 hectares de manguezais para proteger contra a erosão costeira.',
