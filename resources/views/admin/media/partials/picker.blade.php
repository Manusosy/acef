    ...
    <div class="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-5xl h-[85vh] shadow-2xl relative overflow-hidden flex flex-col border border-gray-100 dark:border-gray-800 transition-colors">
        ...
        <div class="flex-1 flex overflow-hidden bg-gray-50 dark:bg-gray-950 transition-colors">
                    ...
                    <div x-show="!loading && items.length > 0" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 pb-20">
                        <template x-for="item in items" :key="item.id">
                            <div @click="selectItem(item)" 
                                 :class="selectedItem?.id === item.id ? 'ring-4 ring-emerald-500 ring-offset-4 ring-offset-gray-50 dark:ring-offset-gray-950 scale-95 shadow-2xl z-10' : 'hover:scale-105 hover:shadow-lg'"
            ...
            <div x-show="selectedItem" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0"
                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-800 flex flex-col items-center text-center">
                    ...
                    <h4 class="text-xs font-black text-gray-900 dark:text-white truncate w-full px-2 mb-1" x-text="selectedItem?.original_filename"></h4>
                ...
                <div class="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                             <input type="text" :value="selectedItem?.url" readonly 
                             ...
                             <button @click="navigator.clipboard.writeText(selectedItem?.url)" class="p-2.5 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-emerald-600 transition-colors">
        ...
        <div class="px-6 py-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between bg-white dark:bg-gray-900 z-30 transition-colors">
            <div class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">
                <span x-show="selectedItem" x-text="'Selected: ' + selectedItem?.original_filename" class="text-emerald-600 dark:text-emerald-400"></span>
            </div>
