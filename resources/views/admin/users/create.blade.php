<x-app-dashboard-layout>
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Create a new user and assign roles.</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.users.store') }}" class="max-w-3xl" x-data="{ role: '{{ old('role_id') }}' }">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                     <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" checked class="rounded border-gray-300 dark:border-gray-600 text-acef-green focus:ring-acef-green w-5 h-5">
                ...
                <div class="col-span-2 border-t border-gray-100 dark:border-gray-700 pt-4 mt-2">
                    <h4 class="text-sm font-bold text-gray-900 dark:text-white mb-4">Security</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
