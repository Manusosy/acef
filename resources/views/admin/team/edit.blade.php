            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center pt-8">
                     <label class="inline-flex items-center cursor-pointer">
                         <input type="checkbox" name="is_founder" value="1" {{ $teamMember->is_founder ? 'checked' : '' }} class="form-checkbox h-5 w-5 text-acef-green rounded border-gray-300 focus:ring-acef-green">
