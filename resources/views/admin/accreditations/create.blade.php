<x-app-dashboard-layout>
    <x-slot name="header">Add Accreditation</x-slot>
    <x-slot name="title">Add Accreditation</x-slot>
    ...
    <div class="max-w-4xl">
        ...
        <form action="{{ route('admin.accreditations.store') }}" method="POST" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="acronym" placeholder="e.g. UN, WB" required maxlength="10" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="3" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"></textarea>
                </div>
            </div>
