    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Onboard a new strategic or implementation partner</p>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-[32px] border border-gray-100 dark:border-gray-700 p-8 shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div x-data="{ 
                        ...
                        <input type="hidden" name="logo" x-ref="logoInput">
                    </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" required class="w-full bg-gray-50 dark:bg-gray-900 border-none rounded-xl text-sm font-semibold focus:ring-2 focus:ring-emerald-500/20 dark:text-gray-300" placeholder="e.g. UN@Environment">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="category" required class="w-full bg-gray-50 dark:bg-gray-900 border-none rounded-xl text-sm font-semibold focus:ring-2 focus:ring-emerald-500/20 dark:text-gray-300">
                                ...
                                <option value="institutional">Institutional Backing</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="4" class="w-full bg-gray-50 dark:bg-gray-900 border-none rounded-xl text-sm font-semibold focus:ring-2 focus:ring-emerald-500/20 dark:text-gray-300" placeholder="Write a brief overview of the partner..."></textarea>
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Website URL</label>
                        <input type="url" name="website" class="w-full bg-gray-50 dark:bg-gray-900 border-none rounded-xl text-sm font-semibold focus:ring-2 focus:ring-emerald-500/20 dark:text-gray-300" placeholder="https://example.com">
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Sort Order</label>
                        <input type="number" name="sort_order" value="0" class="w-full bg-gray-50 dark:bg-gray-900 border-none rounded-xl text-sm font-semibold focus:ring-2 focus:ring-emerald-500/20 dark:text-gray-300">
                    </div>
                    ...
                    <div class="md:col-span-2 flex flex-wrap gap-8 pt-4">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer group">
                            <input type="checkbox" name="show_on_homepage" value="1" class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-emerald-500"></div>
