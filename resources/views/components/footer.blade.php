        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-white/10 pb-16">
            ...
            <div class="space-y-6">
                <a href="/" class="flex items-center space-x-2">
                    ...
                    @else
                        <span class="text-acef-gold font-bold text-3xl tracking-tighter italic">{{ $siteName }}</span>
                    @endif
                </a>
            ...
            <div>
                ...
                <ul class="space-y-4 text-white/60 font-medium">
                    <li><a href="{{ route('home') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.home') }}</a></li>
                    <li><a href="{{ route('about') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.about') }}</a></li>
                    <li><a href="{{ route('programmes') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.programmes') }}</a></li>
                    <li><a href="{{ route('projects') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.projects') }}</a></li>
                    <li><a href="{{ route('get-involved') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.get_involved') }}</a></li>
                    <li><a href="{{ route('contact') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.contact') }}</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-white/60 font-medium">
                    <li><a href="{{ route('impact') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.impact_reports') }}</a></li>
                    <li><a href="{{ route('resources') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.knowledge_hub') }}</a></li>
                    <li><a href="{{ route('news') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.news_insights') }}</a>
                    </li>
                    <li><a href="{{ route('gallery') }}"
                            class="hover:text-acef-light-green transition-colors">{{ __('navigation.media_gallery') }}</a>
                    </li>
                </ul>
            </div>
